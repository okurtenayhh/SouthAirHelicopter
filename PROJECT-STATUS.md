...
**One judgement call worth flagging for review.** His safety answer — *"SAH has never had a
maint. related accident in it's 47 yr. history"* — is published as **"Zero ·
Maintenance-related accidents since 1979"**. The claim is unchanged and is his; only the
*form* changed, from an age that rots to a year that doesn't. It is a strong claim on an
aviation site and he made it in answer to a question that asked plainly whether it was true
and whether he wanted it published. **If anyone is going to want it softened, it will be
him, and it should be his call, not ours.**
