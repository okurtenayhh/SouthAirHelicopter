...
- **⚠ The logo may breach Canva's licence, and this is now the most serious open item on the mark** (2026-08-10). **Provenance, stated by the user:** the **helicopter art was made in Canva**, and the **logo composition in Claude Design**. *(An earlier version of this file inferred the aircraft came from the 2026-08-06 in-house prompt built off Bell's spec PDF and a watermarked the-blueprints.com drawing. That inference was wrong and is retracted — but the prompt still exists and is still useful, see below.)* **The problem:** Canva's Content License Agreement states plainly — *"You may not use any Free or Pro Content as part of a trademark, design mark, trade name, business name, service mark, or logo."* Fonts, simple shapes and lines are the only exceptions. Canva's reasoning is that stock content is licensed **non-exclusively**, so it cannot function as a mark. **So everything turns on one unanswered question: was the helicopter a Canva stock element, or Canva AI output (Magic Media / Dream Lab)?**
  - **If it is a stock element — the mark cannot be used as-is.** Not a risk to weigh, a licence term to comply with. The aircraft would have to be replaced.
  - **If it is Canva AI — usable, with two caveats.** Commercial use requires a **paid plan**; AI output generated on the Free plan is not licensed for commercial use. And AI-generated artwork is not copyrightable in the US, so South Air would hold no exclusive rights in the drawing and **the mark would likely be unregistrable as a trademark.** For a small MRO shop that may be perfectly acceptable — it is a business decision, not a blocker — but it should be a decision, not a surprise.
  - Canva additionally disclaims any guarantee that AI output is cleared for use, and puts responsibility on the user for anything the image depicts. **That points straight back at the 429 question below.**
